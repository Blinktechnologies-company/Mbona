...
const SurvivorCard = () => {
  return (
    <div className="flex flex-col items-center justify-center bg-white shadow-lg w-[407px] p-4 h-[231px] ml-10 mt-10 rounded-lg">
      ...
      <span className="text-center text-[#000000CC] font-medium">
        {" "}
