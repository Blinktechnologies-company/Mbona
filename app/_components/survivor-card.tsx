...
const SurvivorCard = () => {
  return (
    <div className="flex flex-col items-center justify-center bg-white shadow-lg w-full sm:w-[280px] md:w-[350px] lg:w-[400px] xl:w-[450px] p-4 sm:p-5 md:p-6 min-h-[200px] sm:min-h-[220px] md:h-[250px] mx-auto sm:ml-4 md:ml-6 lg:ml-10 mt-4 sm:mt-6 md:mt-10 lg:mt-15 rounded-lg">
      <Bookmark className="text-white bg-[#00936754] rounded-full p-2 w-10 h-10 sm:w--[45px] sm:h-[15px] md:w-[45px] md:h-[45px] mb-3 sm:mb-4 flex-shrink-0" />
      <h2 className="font-bold mb-3 sm:mb-4 text-sm sm:text-base md:text-[17px] text-center">
        Genocide Survivors
      </h2>
      <span className="text-center text-[#000000CC] font-medium w-full text-[13px] sm:text-[14px] md:text-[14px] px-2">
